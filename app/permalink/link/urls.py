...
from link.views.views import LinkTableView, LinkRowView, MycloudLinkTableView, MycloudLinkRowView, edit_link, delete_links, toolbar
...
urlpatterns = [
    ...
    # path("mycloud/<int:pk>", MycloudLinkTableView.as_view(), name="mycloud-link-home"),
